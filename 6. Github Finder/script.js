...
async function searchUser() {
    ...
    try {
        ...
        // https://api.github.com/users/LibanAnsari
        ...
        console.log("User Data is here my lord", userData);
...
async function fetchRepos(reposUrl) {
    ...
    try {
        const response = await fetch(reposUrl + "?per_page=10")
